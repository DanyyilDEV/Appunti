...
int main(){
    ...
    printf("\n buffer1: %s, buffer2: %s", buffer1, buffer2);
		...
		// In genere fgets() si usa leggendo linee di testo, una per volta, assumendo 
		// che ogni linea di testo abbia una certa lunghezza massima. 

		// Successivamente i caratteri della linea di testo saranno elaborati
		// opportunamente
}
